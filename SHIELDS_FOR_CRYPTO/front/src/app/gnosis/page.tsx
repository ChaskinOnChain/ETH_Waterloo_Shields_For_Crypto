    ...
    <>
      <main className="relative">
        <div className="h-[21.5rem] opacity-50 w-screen absolute -left-12">
          <Image src="/gnosistop.png" fill={true} alt="gnosis" />
        </div>
        <div className="pl-[10rem] pt-[25rem] w-[48rem] mb-72">
          <h3 className="font-bold text-5xl mb-4 text-green-500 pb-6">
            {" "}
            Gnosis Stands With Crypto
          </h3>
          <p className="text-center text-2xl">
            The Gnosis Shield is an NFT emblem of defiance, crafted on the Gnosis blockchain,
            standing as a testament to your active engagement and backing in our collective crusade
            for digital freedom. By minting this, you not only qualify for a larger share of the
            airdrop tokens, but also elevate your influence in this pivotal struggle. No need to be
            as quiet as an owl about it – we're shaping our digital destiny together
          </p>
          ...
          <div className="bg-slate-900 h-[30rem] w-[38rem] absolute right-4 top-64 rounded-md flex flex-col gap-3 justify-center items-center border">
            ...
            <span className="font-bold text-xl">0.01 xDAI</span>
          ...
          {isConnected && responseBytes && !minted && (
            <div className="text-center pt-8 text-xl flex flex-col gap-4 items-center">
              ...
              <button
                className="bg-green-500 text-white w-[95%] p-4 font-bold text-2xl rounded-2xl"
